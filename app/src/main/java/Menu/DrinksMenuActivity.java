...
import com.example.restaurantorg.orgrestaurant.Adapters.ItemAdapterDrinks;
...
public class DrinksMenuActivity extends AppCompatActivity implements View.OnClickListener {
    RecyclerView recyclerView;
    private ItemAdapterDrinks adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = findViewById(R.id.btn_add_to_cart_drinks);

        img = findViewById(R.id.imageButtonDrinks);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.addItemDecoration(new DividerItemDecoration(this, LinearLayoutManager.VERTICAL));
        itemsList = new ArrayList<>();
        bill = new ArrayList<>();
        adapter = new ItemAdapterDrinks(this, itemsList);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_add_to_cart_drinks: {
                {addToCart();
                }
                break;
            }

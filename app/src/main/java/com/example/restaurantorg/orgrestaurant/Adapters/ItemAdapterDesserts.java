...
public class ItemAdapterDesserts extends RecyclerView.Adapter<ItemAdapterDesserts.ItemHolderDesserts> {

    private Context context;
    private ArrayList<Item> items;
    private int checkedPosition=0;

    public ItemAdapterDesserts(DessertMenuActivity context, ArrayList<Item> items) {
    ...
    @NonNull
    @Override
    public ItemHolderDesserts onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.menu_layout_item, parent, false);
        return new ItemHolderDesserts(view);
    }


    @Override
    public void onBindViewHolder(@NonNull ItemHolderDesserts holder, int position) {
    ...
    class ItemHolderDesserts extends RecyclerView.ViewHolder{
        private TextView txtName, txtDescription,txtPrice;
        private ImageView imageView;

        public ItemHolderDesserts(@NonNull View itemView) {
            super(itemView);
